...
plot(data_cons$sub_date_time,as.numeric(data_cons$Voltage), type="l",xlab="datetime",ylab="Voltage")
...
plot(data_cons$sub_date_time,as.numeric(data_cons$Global_reactive_power),type="l",xlab="datetime",ylab="Global_reactive_power")
